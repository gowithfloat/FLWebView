...
FLWebView is available through [CocoaPods](http://cocoapods.org). To install
...
&copy; 2016 [Float](https://gowithfloat.com/). Shared under an [MIT license](https://en.wikipedia.org/wiki/MIT_License). See [LICENSE](./LICENSE) for details.
